...
public class Methods {
    ...
    public static void main(String[] args) {
        ...
        int[] array = PolychitNovblyMassiv(bm);
        System.out.println("8)" + "Проверка возвращаемого значения --> " + array[0] + array[1] + array[2] + array[3]);
        Methods.summaVsehElementovMassiva(array12);
        System.out.println("9)" + "Проверка возвращаемого значения --> " + Methods.summaVsehElementovMassiva(array12));
        ...
        String last = null;
        lastElementOfArray(array1, last);

        countedLetters(stringWithALetter);
        int amount = 50000;
        Methods.getKoshelek(amount);
    ...
    private static boolean getEqualityOfData(boolean aa, boolean bb) {
        boolean cc = ((aa == true && bb == true) || (aa == false && bb == true) || (aa == true && bb == false)) ? true : false;
        return cc;
    }
    ...
    private static int[] PolychitNovblyMassiv(int[] bm) {
    ...
    private static int summaVsehElementovMassiva(int[] array12) {
        for (int x : array12) {
            sum1 = x + sum1;
        }
        return sum1;
    ...
    public static String lastElementOfArray(String[] array1, String last) {
        System.out.println(last = array1[array1.length - 1]);
        return last;
    }
    ...
    private static int getKoshelek(int amount) {
